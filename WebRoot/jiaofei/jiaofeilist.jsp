...
<TABLE id="massage" width="100%" cellSpacing=1 borderColorDark=#ffffff cellPadding=0 height="400px" align=center bgColor=#cccccc borderColorLight=#999999 border=0>
  <TBODY>
    	已报到：${total }人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已缴费：${jiaofei }人
    <TR bgcolor="#F2F9FD">
