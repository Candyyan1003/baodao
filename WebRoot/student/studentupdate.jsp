  ...
  <TBODY >
    ...
    <TR>
      ...
      <TD width=400  height=40>
      	<input  type="text" name="name"  id='nameid'  size="30" value="${bean.name }" onblur="checkName()" />
      	<!-- 错误信息 -->
      	 <div class="errorName">
    ...
    <TR>
     ...
     <TR>
      ...
      <TD width=400  height=40>
      	<input  type="text" name="sfz"  id='sfzid'  size="30" value="${bean.sfz }" onblur="checkSfz()"/>
      	<!-- 身份证错误提示信息 -->
      	<div class="sfznull" >
     ...
     <TR>
      ...
      <input  type="text" name="minzu"  id='minzuid' value="${bean.minzu }" size="30"  />
      </TD>
    ...
    <input type="hidden" value="${xueyuan }" name="xueyuan"/>
    ...
    <TR>
      ...
      <TD width=400  height=40>
      	...
      	<c:forEach items="${listZy }" var="one">
      		...
      		<c:choose>
      			<c:when test="${one.id==bean.zhuanye.id }">
      				<option selected="selected" value="${one.id }">${one.depart }</option>
      			</c:when>
