...
<TABLE id="massage" width="100%" cellSpacing=1 borderColorDark=#ffffff cellPadding=0align=center bgColor=#cccccc borderColorLight=#999999 border=0>
  <TBODY>
   已报到：${total1 }人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已体检：${total }人
    <TR bgcolor="#F2F9FD">
